    ...
    return {
        create:function(a , b){
            ...
            constructor:function(a , b){
                ...
                return this._setMapDiv(!1), this._responsiveResize && h.mixin(this._options , {smartNavigation:!1 , autoResize:!1}), this._map=new a(this._mapDivId , this._options), this._setPopup(), this._bindEvents(), this._mapDiv.__map=this._map, this._map
            } , createWebMap:function(a){
                var c , d , e;
                return this._setMapDiv(!1), this._options.hasOwnProperty("mapOptions") || (this._options.mapOptions={}), this._responsiveResize && h.mixin(this._options.mapOptions , {smartNavigation:!1 , autoResize:!1}), c=b.createMap(a , this._mapDivId , this._options), this._mapDeferred=c, d=this, e=function(a){
                ...
                }, this._map.loaded ? h.hitch(this , a)
                    .call() : this._handles.push(e(this._map , "load" , h.hitch(this , a))), b=function(){
                ...
                }, this._map.loaded ? h.hitch(this , b)
                    .call() : this._handles.push(e(this._map , "load" , h.hitch(this , b))), c=function(a , b , c){
                    return function(){
                        function e(){
