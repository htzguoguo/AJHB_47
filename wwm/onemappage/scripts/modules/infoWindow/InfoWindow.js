        ...
        return declare([InfoWindowBase, Evented],
            {
                constructor: function (parameters) {
                    ...
                    this._arrow = domConstruct.create("div", {"class": "xndw_sj"}, this.domNode);
                    this._mainCon = domConstruct.create("div", {"class": "mainCon"}, this.domNode);
                    this._closeButton = domConstruct.create("div", {"class": "btn_close", "title": "关闭"}, this.domNode);
                ...
                _showInfoWindow: function (x, y) {
                    ...
                    domStyle.set(this.domNode, {
                        "left": x - infoWidth / 2 + 220 + "px",  //小尾巴x位置
                        "top": y - infoHeight + 30 + "px"   //下尾巴y位置
                    });
                ...
                show: function (location) {
                    ...
                    var left = location.x - infoWidth / 2 + 100;
                    var top = location.y - infoHeight - 5;
