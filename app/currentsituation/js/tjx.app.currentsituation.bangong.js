 ...
 */
/*global $, tjx */
tjx.app.currentsituation.bangong = (function () {
           ...
           /* {
            ...
            }*/
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return   ' <a href="javascript:void(0);" onclick="tjx.app.currentsituation.bangong.onShowInfo(\'' +  field +  '\',\'' + value  +  '\');" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> 查看 </a>';
                },
                "targets": 4
            }
        ];
...
// Begin DOM method /setJqueryMap/
    ...
    setDataTable = function ( src, values ) {
        ...
        var search = {
            Fields : [ '企业名称',   '办公楼名称', '办公楼面积', '房屋空置面积', 'unitID', 'ZID'],
            OrderFieldName : '房屋空置面积',
            OrderType : 'desc'
        };
        if ( src  ){
            search.Search  =   src;
