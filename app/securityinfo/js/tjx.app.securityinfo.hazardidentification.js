 ...
 */
/*global $, tjx */
tjx.app.securityinfo.hazardidentification = (function () {
...
// example: onClickButton = ...
    onSumitData = function ( event ) {
        ...
        if (jqueryMap.$form.validate().form()){
            ...
            tjx.data.hazardidentification.addhazardidentificationInfo( arg_map );
        }
    ...
    onSuccess = function ( data  ) {
        if ( data.IsSuccess ){
            tjx.util.ui.showSuccess( '系统提示' , '危险辨识及控制措施登记完成。');
            ...
            tjx.util.ui.showAlert( '系统提示' , '危险辨识及控制措施登记不成功，请重试。');
        }
    }
    ...
    onInitForm = function (  ) {
        ...
        tjx.data.hazardidentification.gethazardidentificationInfo( arg_map );
    }
    ...
    onEditData = function ( event ) {
        ...
        tjx.data.hazardidentification.updatehazardidentificationInfo( arg_map );
    }

    onEditSuccess = function ( data ) {
        if ( data.IsSuccess ){
            tjx.util.ui.showSuccess( '系统提示' , '危险辨识及控制措施更新完成。');
            $.gevent.publish( 'table-update', [ {} ]);
        }else{
            tjx.util.ui.showAlert( '系统提示' , '危险辨识及控制措施更新不成功，请重试。');
        }
    }
