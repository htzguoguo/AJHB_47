 ...
 */
/*global $, tjx */
tjx.data.certification = (function () {
//---------------- BEGIN MODULE SCOPE VARIABLES --------------
    var
        configMap = {
            save_url : '',
            add_url : 'SecurityInfoService/certification/ddc',
            get_url : 'SecurityInfoService/certification/'
        },
...
//------------------- BEGIN PUBLIC METHODS -------------------
    ...
    addCertification = function ( arg_map ) {
    ...
    getCertification = function ( arg_map ) {
    ...
    updateCertification = function ( arg_map ) {
