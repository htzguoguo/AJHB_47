 ...
 */
/*global $, tjx */
tjx.data.securityinfo = (function () {
//---------------- BEGIN MODULE SCOPE VARIABLES --------------
    var
        configMap = {
            save_url : '',
            add_url : 'SecurityInfoService/enterprise/ddc',
            get_url : 'SecurityInfoService/enterprise/key/',
            get_edit_url : 'SecurityInfoService/enterprise/ed/',
            update_url : 'SecurityInfoService/enterprise/'
...
// return public methods
    return {
        ...
        getSecurityEditInfo : getSecurityEditInfo
    };
//------------------- END PUBLIC METHODS ---------------------
}());
